...
import delogo from "../public/decentral.svg";
import Mail from "../public/mail_logo.svg";
import Vector from "../public/Vector_logo.svg";
    ...
    <div className={styles.footer_container}>
        ...
        <div className={styles.footer_three}>
          <div className={styles.disclaimer}>
            <p>
              ...
              “Dewallstreet Private Limited”, under Mnistry of Corporate Affairs
              (MCA), Registrar of Companies (RoC), Chennai, South India which
              specializes in consultancy services for legal,finances and
              technological security and compliance aspects is the only legal
              entity, as of now which is under multiple pivotizations into
              separate legal entitities of the conglomerate, de industries and
              the parent trust as zero community foundation.
            </p>
          </div>
      ...
      <div className={styles.footer_container_three}>
        ...
        <div className={styles.end}>
          <Image src={De} width={30} height={20} layout={"fixed"} />
          <p>INDUSTRIES</p>
        </div>
      </div>
    </div>
